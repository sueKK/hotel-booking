...
const Hero = () => {
  return (
    ...
    bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
        ...
        font-bold md:font-extrabold max-w-xl mt-4'>Discover Your Perfect Geteway Destination</h1>
        
        <p className='max-w-130 mt-2 text-sm md:text-base'>Unpralleled luxury and comfort await at the world's most exclusive Hotels and resorts.
